...
class CustomTextFormField extends StatelessWidget {
  CustomTextFormField({
    ...
    this.filled = true,
    this.validator,
    this.readOnly = false, // Add the readOnly parameter
  }) : super(key: key);
  ...
  final bool readOnly; // Declare readOnly parameter
  ...
  Widget textFormFieldWidget(BuildContext context) => SizedBox(
    ...
    child: TextFormField(
      ...
      validator: validator,
      readOnly: readOnly, // Pass readOnly parameter to TextFormField
    ),
  );
  ...
  InputDecoration get decoration => InputDecoration(
    ...
    fillColor: fillColor ?? theme.colorScheme.onPrimaryContainer.withOpacity(1),
    filled: filled,
