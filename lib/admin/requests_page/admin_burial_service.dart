...
import '../status_card_clickable/burial_filtered_request_screen.dart';

class AdminBurialServiceRequest extends StatefulWidget {
  const AdminBurialServiceRequest({Key? key}) : super(key: key);
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => BurialFilteredRequestScreen(status: status.toLowerCase(), requests: allRequests),
          ),
        );
      },
      child: Container(
