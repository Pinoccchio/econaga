...
import '../status_card_clickable/garbage_filtered_requests_screen.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => GarbageFilteredRequestScreen(status: status.toLowerCase(), requests: allRequests),
          ),
        );
      },
      child: Container(
