...
class LipatBahayFilteredRequestScreen extends StatefulWidget {
  final String status;
  final List<DocumentSnapshot> requests;

  const LipatBahayFilteredRequestScreen({Key? key, required this.status, required this.requests}) : super(key: key);

  @override
  _LipatBahayFilteredRequestScreenState createState() => _LipatBahayFilteredRequestScreenState();
}
